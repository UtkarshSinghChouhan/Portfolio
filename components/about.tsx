...
const About = () => {
  ...
  return (
    <motion.section
      ...
      className="scroll-mt-28 cursor-default mb-28 max-w-[45rem] text-center leading-8"
    >
      <Sectionheading heading={`About me`} />
      <p className="mb-3">
        After graduating with a degree in{" "}
        <span className="font-medium">Computer Application(MCA)</span>, I
        ...
        <span className="font-medium">
          React, Next.js, Typescript, and Framer-Motion.
        </span>
